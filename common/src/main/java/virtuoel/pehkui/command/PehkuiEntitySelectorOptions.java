...
public class PehkuiEntitySelectorOptions
{
	...
	{
		// Vanilla only populates its own options while the map is still empty, so make sure it
		// has run before adding to it. The call is a no-op once the options are in place.
	...
	private PehkuiEntitySelectorOptions()
	{
