...
public class AbstractThrownPotionMixin
{
	...
	private AABB pehkui$onHitAsWater$inflate(AABB obj, double x, double y, double z, Operation<AABB> original)
	{
	...
	private double pehkui$onHitAsWater$maxDist(double value)
	{
