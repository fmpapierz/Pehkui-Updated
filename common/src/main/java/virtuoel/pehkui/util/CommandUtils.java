...
public class CommandUtils
{
	...
	/**
	 * Each loader project passes in its own way of adding to the command argument type registry.
	 */
	...
	public static boolean testFloatRange(MinMaxBounds<Double> range, float value)
	{
		return range instanceof MinMaxBounds.Doubles && ((MinMaxBounds.Doubles) range).matches(value);
	}
